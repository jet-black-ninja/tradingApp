...
4. Compile the application using Visual Studio Code with the following command:
   ```
   g++ -o "output/output file name" main.cpp curl_functions.cpp functions.cpp -lcurl -ljsoncpp
   ```

5. Run the compiled application using the following command:
   ```
   ./output/output file
   ```
6. **Shortcut for running and compiling:**
